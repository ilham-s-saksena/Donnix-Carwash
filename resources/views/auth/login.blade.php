...
<head>
	...
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('template/assets/img/bersihin.jpg')}}">
</head>
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('template/assets/img/bersihin.jpg')}}" alt="" width="70%"></div>
